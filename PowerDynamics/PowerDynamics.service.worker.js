...
/** @type {string[]} */
const CACHED_FILES = ["PowerDynamics.html","PowerDynamics.js","PowerDynamics.offline.html","PowerDynamics.icon.png","PowerDynamics.apple-touch-icon.png","PowerDynamics.audio.worklet.js","PowerDynamics.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["PowerDynamics.wasm","PowerDynamics.pck"];
