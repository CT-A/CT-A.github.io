...
/** @type {string} */
const CACHE_VERSION = '1743535392|192865537';
/** @type {string} */
const CACHE_PREFIX = 'Power Game-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Power Game.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Power Game.html","Power Game.js","Power Game.offline.html","Power Game.icon.png","Power Game.apple-touch-icon.png","Power Game.audio.worklet.js","Power Game.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Power Game.wasm","Power Game.pck"];
